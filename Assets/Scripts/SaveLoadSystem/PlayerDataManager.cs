      ...
      for (int i = 0; i < playerInventory.slots.Length; ++i) {
        switch (data.inventory[i]) {
          ...
          case 2:
            ...
            break;
          case 3:
            loadedObj = loaderComponent.LoadObjectOnScene(loaderComponent.gun1Button,
              playerInventory.buttonSlots[i].transform);
            ...
            break;
          case 4:
            loadedObj = loaderComponent.LoadObjectOnScene(loaderComponent.gun2Button,
              playerInventory.buttonSlots[i].transform);
          ...
          case 5:
            ...
            break;
          case 6:
            loadedObj = loaderComponent.LoadObjectOnScene(loaderComponent.outfit1Button,
              playerInventory.buttonSlots[i].transform);
            ...
            break;
          case 7:
            loadedObj = loaderComponent.LoadObjectOnScene(loaderComponent.outfit2Button,
              playerInventory.buttonSlots[i].transform);
