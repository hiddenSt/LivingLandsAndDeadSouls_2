...
namespace PlayFab {
  ...
  public static class PlayFabSettings {
    ...
    public static bool DisableAdvertising {
      get => staticSettings.DisableAdvertising;
      set => staticSettings.DisableAdvertising = value;
    }
    ...
    public static bool DisableDeviceInfo {
      get => staticSettings.DisableDeviceInfo;
    ...
    public static bool DisableFocusTimeCollection {
      get => staticSettings.DisableFocusTimeCollection;
    ...
    public static string GetFullUrl(string apiCall, Dictionary<string, string> getParams,
      ...
      if (apiSettings != null) {
        ...
        if (!string.IsNullOrEmpty(apiSettings.VerticalName)) verticalName = apiSettings.VerticalName;
        if (!string.IsNullOrEmpty(apiSettings.TitleId)) titleId = apiSettings.TitleId;
      }
      ...
      if (titleId == null) titleId = PlayFabSharedPrivate.TitleId;

      var baseUrl = productionEnvironmentUrl;
      if (!baseUrl.StartsWith("http")) {
        sb.Append("https://");
        if (!string.IsNullOrEmpty(titleId)) sb.Append(titleId).Append(".");
        if (!string.IsNullOrEmpty(verticalName)) sb.Append(verticalName).Append(".");
      }
