...
namespace PlayFab {
  ...
  internal class PlayFabSettingsRedirect : PlayFabApiSettings {
    ...
    public override string AdvertisingIdType {
      get {
        var so = GetSO();
        return so == null ? base.AdvertisingIdType : so.AdvertisingIdType;
      }
      set {
        var so = GetSO();
        if (so != null) so.AdvertisingIdType = value;
    ...
    public override string AdvertisingIdValue {
      get {
        var so = GetSO();
        return so == null ? base.AdvertisingIdValue : so.AdvertisingIdValue;
      }
      set {
        var so = GetSO();
        if (so != null) so.AdvertisingIdValue = value;
    ...
    public override bool DisableAdvertising {
      get {
        var so = GetSO();
        return so == null ? base.DisableAdvertising : so.DisableAdvertising;
      }
      set {
        var so = GetSO();
        if (so != null) so.DisableAdvertising = value;
